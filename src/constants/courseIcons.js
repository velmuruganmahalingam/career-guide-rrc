...
const subjectIcons = {
    ...
    'Civil Engineering': { icon: FaIcons.FaBuilding, color: 'gray' },
    'Mechanical': { icon: FaIcons.FaWrench, color: 'yellow' },
    'Electrical': { icon: FaIcons.FaBolt, color: 'yellow' },
    ...
    'Biology': { icon: FaIcons.FaDna, color: 'green' },
    'Mathematics': { icon: FaIcons.FaCalculator, color: 'red' },
    'Literature': { icon: FaIcons.FaBook, color: 'yellow' },
    'History': { icon: FaIcons.FaLandmark, color: 'yellow' },
    'Geography': { icon: FaIcons.FaGlobe, color: 'blue' },
    'Economics': { icon: FaIcons.FaChartLine, color: 'green' },
    'Political Science': { icon: FaIcons.FaVoteYea, color: 'red' },
    'Psychology': { icon: FaIcons.FaBrain, color: 'purple' },
    ...
    'Marketing': { icon: FaIcons.FaBullhorn, color: 'red' },
    'Human Resources': { icon: FaIcons.FaUserTie, color: 'indigo' },
    ...
    'Machine Learning': { icon: FaIcons.FaBrain, color: 'purple' },
    'Web Development': { icon: FaIcons.FaCode, color: 'indigo' },
